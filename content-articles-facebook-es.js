...
<li>Coordinación de migración y mercado laboral (con ejecución cantonal).</li>
<li>Infraestructura y estadísticas federales.</li>
</ul>
<h3>Qué suele variar por cantón</h3>
<ul>
<li><strong>Impuestos</strong> (carga real y deducciones).</li>
<li><strong>Escuela</strong> (calendario, organización, criterios).</li>
<li><strong>Procedimientos</strong> (citas, formularios, plazos, oficinas).</li>
</ul>
<h3>Qué suele depender de tu comuna</h3>
<ul>
<li>Registro al llegar (control de habitantes).</li>
...
<p><strong>Relacionado:</strong> <a href="#/cantones-suiza">#/cantones-suiza</a>, <a href="#/impuestos-en-suiza">#/impuestos-en-suiza</a>, <a href="#/registrarse-en-suiza">#/registrarse-en-suiza</a></p>
        </div>`
    },
...
<p>Permite proponer un cambio: en la práctica abre un proceso político y termina en votación si cumple requisitos formales.</p>
<h3>Lo importante para un expatriado</h3>
<ul>
<li>Muchas decisiones que afectan a tu vida (movilidad, vivienda, reglas locales) pueden estar en votación.</li>
...
<p>Relacionado: <a href="#/introduccion-suiza-como-funciona">#/introduccion-suiza-como-funciona</a>, <a href="#/cantones-suiza">#/cantones-suiza</a></p>
        </div>`
    },
...
<p>Relacionado: <a href="#/permisos-suiza">#/permisos-suiza</a>, <a href="#/registrarse-en-suiza">#/registrarse-en-suiza</a>, <a href="#/reagrupacion-familiar-suiza">#/reagrupacion-familiar-suiza</a></p>
        </div>`
    },
...
<li>Lista de roles/empresas objetivo.</li>
...
<p>En Suiza, la consistencia vale oro: método + pruebas + seguimiento.</p>
    ...
    "fb-seguro-medico-lamal-elegir": {
        ...
        description: "Guía para elegir LAMal en Suiza: modelos (HMO/medico de cabecera/telmed), franquicia, copago, cambio anual y errores frecuentes. Con fuentes oficiales.",
...
<li><strong>Médico de cabecera</strong>: coordinación por un médico principal.</li>
<li><strong>Telmed</strong>: primero llamas; luego te derivan.</li>
<li><strong>HMO</strong>: red/centro médico asignado.</li>
</ul>
<h3>Franquicia + copago (visión general)</h3>
<ul>
<li>La franquicia es el “umbral” anual que pagas antes de reembolso.</li>
<li>Después suele existir participación (copago) hasta un tope.</li>
<li>Elegir franquicia alta baja la prima, pero aumenta tu riesgo de gasto.</li>
</ul>
...
<p>Relacionado: <a href="#/seguro-medico-lamal-suiza">#/seguro-medico-lamal-suiza</a>, <a href="#/franquicia-seguro-medico-suiza">#/franquicia-seguro-medico-suiza</a></p>
        </div>`
    },
...
<p>Relacionado: <a href="#/costo-de-vida-suiza">#/costo-de-vida-suiza</a>, <a href="#/transporte-publico-suiza">#/transporte-publico-suiza</a>, <a href="#/seguro-medico-lamal-suiza">#/seguro-medico-lamal-suiza</a></p>
        </div>`
    },
...
<li>Visitar y postular con dossier.</li>
<li>Revisión/selección (puede haber competencia).</li>
<li>Firma + entrega de llaves + alta de servicios.</li>
</ol>
<h3>Qué suele llevar un dossier</h3>
<ul>
<li>documento de identidad / permiso (si aplica)</li>
<li>contrato de trabajo o prueba de ingresos</li>
<li>extracto de deudas (Betreibung) si ya resides</li>
<li>carta breve de presentación</li>
</ul>
<h3>Fianza / depósito</h3>
<p>Suele bloquearse como garantía. Exige un procedimiento claro y comprobable.</p>
<h3>Señales de estafa</h3>
<ul>
<li>te piden dinero por adelantado sin contrato verificable</li>
...
<p>Relacionado: <a href="#/alquilar-vivienda-suiza">#/alquilar-vivienda-suiza</a>, <a href="#/fianzas-alquiler-suiza">#/fianzas-alquiler-suiza</a></p>
        </div>`
    },
...
<li>Usa calendario para plazos (seguro, impuestos, citas).</li>
<li>Pregunta siempre por cantón/comuna.</li>
<li>Ten un “dossier” de documentos.</li>
<li>Aprende lo básico del idioma local del cantón.</li>
<li>Revisa tu contrato (alquiler/trabajo) con calma.</li>
<li>Evita ruidos en horarios sensibles.</li>
<li>Recicla según norma local.</li>
<li>Ten RC/seguro de responsabilidad si aplica.</li>
<li>Usa abonos de transporte si te compensa.</li>
<li>Compara primas LAMal cada otoño.</li>
<li>No pagues nada sin contrato verificable.</li>
<li>Haz seguimiento de candidaturas.</li>
<li>Guarda nóminas y certificados de trabajo.</li>
<li>Controla gastos fijos el primer trimestre.</li>
<li>Pregunta por deducciones si haces declaración.</li>
<li>Respeta turnos y reglas en lavanderías comunes.</li>
<li>Cierra el círculo: confirma por escrito.</li>
<li>Planifica mudanzas con margen.</li>
<li>Ten un fondo de emergencia.</li>
<li>No te fíes de “lo vi en Facebook” sin fuente.</li>
<li>Usa portales oficiales como referencia base.</li>
<li>En caso de duda, documenta y consulta.</li>
